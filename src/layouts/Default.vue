    ...
    <footer class="bg-green-700 text-white">
      <div id="contact" class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Copyright {{ new Date().getFullYear() }}. All rights reserved. v.0.0.2</div>
          <div>
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:herve76@gmail.com" class="text-white hover:text-gray-400" aria-label="Email mail to link">
          ...
          <li>
            <a href="https://youtube.com" target="_blank" class="text-white hover:text-gray-400" aria-label="Link to Youtube">
          ...
          <li>
            <a href="https://github.com/jsappme/gridsome-auth0-starter" target="_blank" class="text-white hover:text-gray-400" aria-label="Link to GitHub">
          ...
          <li>
            <a href="https://twitter.com/herve76" target="_blank" class="text-white hover:text-gray-400" aria-label="Link to Twitter">
          ...
          <li>
            <a href="https://instagram.com" target="_blank" class="text-white hover:text-gray-400" aria-label="Link to Instagram">
